...
export default function HomePage() {
  return (
    <main
      ...
      className="mx-[-1rem] flex h-full flex-col items-stretch bg-cover py-8"
    >
      ...
      <div className="flex flex-col items-center">
        <Link
          href="/vote"
          className={`block h-12 w-44 rounded-md text-center leading-[48px] ${oswald.className} bg-lightBlue font-bold uppercase text-blue`}
        >
          Vote now
        </Link>
        <button
